...
if(isset($_GET['Submit'])){
	...
	$html2 .= "		<title>Damn Vulnerable Web App (DVWA) v1.8 :: WooYun-2012-16041</title>\n";
	$html2 .= "		<strong id=\"titleshow\"> aaa </strong>\n";
	$html2 .= "		<script>\n";
	$html2 .= "			document.getElementById(\"titleshow\").innerHTML=\"".$str."\";\n";
	$html2 .= "		</script>\n";
	$html2 .= "	</head>\n";
	$html2 .= "	<body>\n";
	$html2 .= "	</body>\n";
