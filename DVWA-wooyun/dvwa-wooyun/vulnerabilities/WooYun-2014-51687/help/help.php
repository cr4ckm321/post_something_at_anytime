<div class="body_padded">
	...
	<td><div id="code">
		...
		<p> 看上去 80sec 过滤函数在起作用 , 试一下 99 and @`'` /*!50000union*/ select first_name,password from users # @`'` , 去wooyun.org查看原始的漏洞报告！ </p>
	...
	<p>Reference: http://www.wooyun.org/bugs/wooyun-2014-051687</p>
