...
<div class=\"body_padded\">
	...
	<br /><br />
	DVWA WOOYUN edition is a wooyun project.And is based on DVWA project : ) . Add-on material is copyright 2014 Wooyun team & lxj616 <br>
	...
	<ul>
		<li>Wooyun Homepage: ".dvwaExternalLinkUrlGet( 'http://www.wooyun.org/' )."</li>
		<li>DVWA Homepage: ".dvwaExternalLinkUrlGet( 'http://www.dvwa.co.uk/' )."</li>
		<li>DVWA Project Home: ".dvwaExternalLinkUrlGet( 'http://code.google.com/p/dvwa/' )."</li>
		<li>DVWA Issues: ".dvwaExternalLinkUrlGet( 'http://code.google.com/p/dvwa/issues/list' )."</li>
		<li>DVWA SVN: ".dvwaExternalLinkUrlGet( 'http://dvwa.googlecode.com/svn/trunk/' )."</li>
	...
	<ul>
		<li>lxj616: ".dvwaExternalLinkUrlGet( 'http://www.wooyun.org/whitehats/lxj616','http://www.wooyun.org/whitehats/lxj616' )."</li>
	...
	<h2>DVWA License/DVWA Wooyun edition License</h2>
