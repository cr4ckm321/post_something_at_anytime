...
$docs = array(
	'wooyun' => array( 'legend' => 'WooYun', 'file' => 'WOOYUN.txt' ),
	'copying' => array( 'legend' => 'DVWA Copying', 'file' => 'COPYING.txt' ),
...
foreach( array_keys( $docs ) as $docId ) {
	...
	$docMenuHtml .= "<span class=\"submenu_item{$selectedClass}\"><a href=\"?doc={$docId}#here_body\">{$docs[$docId]['legend']}</a></span>";
}
